 ...
 */
abstract class GenericDaoAutoIncImpl[T <: Table[E] with IdentifyableTable[PK], E <: EntityAutoInc[PK, E], PK: BaseColumnType](dbConfigProvider: DatabaseConfigProvider, tableQuery: TableQuery[T]) extends GenericDaoImpl[T, E, PK](dbConfigProvider, tableQuery) with GenericDaoAutoInc[T, E, PK] {
  import shapeless._
  import tag.@@
   ...
   */
  override def createAndFetch(entity: E)(implicit mkLens: MkFieldLens.Aux[E, Symbol @@ Witness.`"id"`.T, PK], ec: ExecutionContext): Future[E] = {
